...
public class MemberInfo {
	private int mi_idx, mi_stamp;
	private String mi_id, mi_pw, mi_name, mi_email, mi_isad, mi_phone, mi_ismem, mi_date, mi_lastlogin, mi_profile;
	...
	public int getMi_stamp() {
		return mi_stamp;
	}
	public void setMi_stamp(int mi_stamp) {
		this.mi_stamp = mi_stamp;
	}
	...
	public String getMi_isad() {
		return mi_isad;
	}
	public void setMi_isad(String mi_isad) {
		this.mi_isad = mi_isad;
	}
	...
	public String getMi_ismem() {
		return mi_ismem;
	}
	public void setMi_ismem(String mi_ismem) {
		this.mi_ismem = mi_ismem;
	}

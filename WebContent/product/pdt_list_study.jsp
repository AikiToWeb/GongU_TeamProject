...
<th>가격대</th>
<td>
	<input type="text" name="sprice" value="<%=pdtPageInfo.getSprice() %>" size="10" />원 ~
	<input type="text" name="eprice" value="<%=pdtPageInfo.getEprice() %>" size="10" />원
</td>
</tr>
...
<p style="width:800px; font-size:80%;" align="right">정렬 조건 :
	...
	<a href="pdt_list.pdt<%=args %>&sort=salecntd" <%=(pdtPageInfo.getSort().equals("salecntd") ? "class='bold'" : "") %>>판매량수</a>&nbsp;
